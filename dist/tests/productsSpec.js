...
const products_1 = require("../models/products"); // as recommended by Udacity I am importing the model (in contract to the other test cases)
const request = (0, supertest_1.default)(server_1.default);
const store = new products_1.ProductStore();
var token;
var userId;
let productId; // variable to hold the newly created productId
/* ===============================================================================
Routes in handler:
