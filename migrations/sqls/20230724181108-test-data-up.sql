...
('Harness', 'The Rock Xplorer Is A Robust, Comfortable All-Rounder.Its Salewa Evobelt Design Combines The Flexibility Of A Floating Waist Belt With Comfortable, Breathable 3D Mesh Fixed Padding To Ensure That Your Harness And Its (Four) Gear Loops Remain Correctly Centred.With Dual 90Safx Buckles At The Waist Belt And Leg Loops For Full Adjustability And Softer Rear Gear Loops To Allow You To Climb Comfortably When Carrying A Pack.', 'harness.jpg', 51.99, 3),
('Catch-22 - Joseph Heller', 'But the enemy above is not Yossarians problem - it is his own army intent on keeping him airborne, and the maddening "Catch-22" that allows for no possibility of escape.No book has satirised military madness so hilariously and tragically.', 'catch22.jpg', 14.95, 1),
